...
export default function Blog(){
    ...
    useEffect(() => {
        ...
        //     const snapShot =await getDocs(collection(db, "blogsOne"));
        ...
        const unsub = onSnapshot(collection(db,"blogsOne"),(snapShot)=>{
            const blogs = snapShot.docs.map((doc)=>{
                return{
                    id:doc.id,
                    ...doc.data()
    ...
    async function handleSubmit(e){
        ...
        const docRef = doc(collection(db, "blogsOne"))
    ...
    async function removeBlog(i){
        ...
        const docRef = doc(db,"blogsOne",i);
